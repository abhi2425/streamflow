...
const Navbar = () => {
   ...
   return (
      <header className='profile-header flex-x-between' onMouseLeave={() => setShowToolTip(false)}>
         <h1 className='logo'>
         ...
         <div className='flex-x-between toolbox'>
            <div style={{ marginRight: '2.5rem' }}>
               <CreatePostBtn logoSize='create-post-logo-small' />
            </div>
            <Avatar
         ...
         <nav
            className={`${showToolTip ? 'show-tooltip' : ''} nav-container nav-tooltip`}
